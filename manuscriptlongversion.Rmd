...
Many hospitals, mainly in HIC, have a trauma registry where they log the patients information and timeline of what happened. This is important work, as a cornerstone of trauma quality improvement programs is multidisciplinary mortality and morbidity review to identify opportunities for improvement and implement corrective actions. OFIs are the endpoint of MoM conferences. Once

This refers to a meeting where different specialities who work with trauma care sit down and go through cases where possible OFIs were identified by nurses who go through the trauma care quality database. These MoM conferences are very resource and time craving, which is why many hospitals doesn't<!-- Do not use contractions--> have the means to perform them. In Sweden In Sweden, most hospitals have mortality conferences on deceased patient cases, but only one has MoM conferences to better their trauma care on patients who lived. Examples of opportunities for improvement may include lack of resources and management errors.
